 ...
 * https://github.com/pdaddyo/soundbounce/tree/master/src/chrome-extension
 */
...
chrome.browserAction.onClicked.addListener(function (tab) {
    ...
    if (tab.url.indexOf("http://play.bungalow.qi") == 0) {
        return;
    }
