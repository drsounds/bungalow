...
/**
 * Table header renderer painting the skinned header background and label via the
 * active skin ({@link se.spacify.skinning.Skin#paintTableHeader} /
 * {@link se.spacify.skinning.Skin#paintText}). Its returned component is the
 * wrapped {@link JLabel} ({@link #getComponent()}).
 */
public class TableHeaderRenderer extends Label implements TableCellRenderer {
	...
	private class SpaceTableCellLabelUI extends LabelUI {
		...
		private final Insets PADS = new Insets(8, 8, 8, 8);
		...
		public void paint(Graphics g, JComponent c) {
			...
			getSkin().paintTableHeader(getTable(), c.getWidth(), c.getHeight(), g2);
