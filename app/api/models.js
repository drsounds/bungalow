...
API.request = function (method, url, params, data) {
...
Collection.prototype.next = function() {
    var self = this;
    return new Promise(function (resolve ,fail) {
        API.request('GET', self.endpoint + '&offset=' + self.offset + '&limit=' + self.limit + '&type=' + self.type).then(function (result) {
...
Playlist.fromUserId = function (user, id) {
    return new Promise(function (resolve, fail) {
        API.request('GET', '/music/users/' + user + '/playlists/' + id).then(function (playlist) {
...
Album.fromId = function (id) {
    return new Promise(function (resolve, fail) {
        API.request('GET', '/music/albums/' + id).then(function (album) {
...
User.fromId = function (id) {
    return new Promise(function (resolve, fail) {
        ...
        var user = parts[2];
        API.request('GET', '/music/users/' + id).then(function (user) {
...
Artist.byId = function (id) {
    return new Promise(function (resolve, fail) {
        API.request('GET', '/music/artists/' + id).then(function (response) {
            resolve(response);
        });
    });
};
...
Chart.fromId = function (id) {
    return new Promise(function (resolve, fail) {
        ...
        API.request('GET', '/music/charts/' + id.split(/\:/g)[2]).then(function (result) {
...
Year.fromYear = function (year) {
    return new Promise(function (resolve, fail) {
        API.request('GET', '/music/years/' + year).then(function (result) {
...
Country.fromCode = function (countryCode) {
    return new Promise(function (resolve, fail) {
        API.request('GET', '/music/countries/' + countryCode).then(function (result) {
